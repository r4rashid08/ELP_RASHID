...
/**
 * Created by ashfaq on 11/17/2016.
 */
...
public class BadgeView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#f20000"); //Color.RED;
    ...
    private void applyLayoutParams() {
        ...
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, 70);
